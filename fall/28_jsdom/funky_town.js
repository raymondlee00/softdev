...
factOutput.addEventListener("click", () => {
  changeOutput("factOutput");
});

var fibOutput = document.getElementById("fibOutput");
fibOutput.addEventListener("click", () => {
  changeOutput("fibOutput");
});

var gcdOutput = document.getElementById("gcdOutput");
gcdOutput.addEventListener("click", () => {
  changeOutput("gcdOutput");
});

var randomStudentOutput = document.getElementById("randomStudentOutput");
randomStudentOutput.addEventListener("click", () => {
  changeOutput("randomStudentOutput");
});